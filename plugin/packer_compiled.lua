...
_G.packer_plugins = {
  ["auto-pairs-gentle"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/auto-pairs-gentle",
  ...
  ["nvim-metals"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-metals",
  ...
  ["rest.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/rest.nvim",
    url = "https://github.com/NTBBloodbath/rest.nvim"
  },
  ["sonarlint.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/sonarlint.nvim",
  ...
  ["vim-freemarker"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-freemarker",
